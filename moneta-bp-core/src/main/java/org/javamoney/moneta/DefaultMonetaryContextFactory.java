 ...
 * #-------------------------------
 * # Custom MathContext, overrides entries from Money.mathContext
...
class DefaultMonetaryContextFactory {
    ...
    public MonetaryContext getContext() {
        try {
            ...
            String value = config.get("Money.defaults.precision");
            if (value!=null) {
    ...
    private MonetaryContext createContextWithConfig(Map<String, String> config) {
        ...
        String value = config.get("Money.defaults.mathContext");
        if (value!=null) {
    ...
    private MonetaryContext createMonetaryContextNonNullConfig(Map<String, String> config, int prec) {
        String value = config.get("Money.defaults.roundingMode");
