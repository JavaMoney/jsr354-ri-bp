 ...
 * the License.
 */
package org.javamoney.moneta.bp.internal.format;
...
import org.javamoney.moneta.bp.format.CurrencyStyle;
...
final class DefaultMonetaryAmountFormat implements MonetaryAmountFormat {
    ...
    /**
     * The current {@link org.javamoney.bp.api.format.AmountFormatContext}, never null.
     */
     ...
     *
     * @param amountFormatContext the {@link org.javamoney.bp.api.format.AmountFormatContext} to be used, not {@code null}.
     */
     ...
     * @throws org.javamoney.bp.api.format.MonetaryParseException if there is a problem while parsing
     */
     ...
     * (non-Javadoc)
     *
     * @see org.javamoney.bp.api.MonetaryQuery#queryFrom(org.javamoney.bp.api.MonetaryAmount)
     */
    @Override
