...
final class LiteralToken implements FormatToken, Serializable {
     ...
     *
     * @see org.javamoney.moneta.bp.internal.format.FormatToken#parse(ParseContext)
     */
    @Override
     ...
     *
     * @see org.javamoney.moneta.bp.internal.format.FormatToken#print(Appendable, org.javamoney.bp.api.MonetaryAmount)
     */
    @Override
