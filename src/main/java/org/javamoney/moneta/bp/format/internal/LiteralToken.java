 ...
 * the License.
 */
package org.javamoney.moneta.bp.format.internal;
...
final class LiteralToken implements FormatToken, Serializable {
     ...
     *
     * @see org.javamoney.moneta.bp.format.internal.FormatToken#parse(ParseContext)
     */
    @Override
     ...
     *
     * @see org.javamoney.moneta.bp.format.internal.FormatToken#print(Appendable, org.javamoney.bp.MonetaryAmount)
     */
    @Override
