...
import org.javamoney.moneta.bp.internal.ConfigurableCurrencyUnitProvider;
...
public final class CurrencyUnitBuilder {
     ...
     */
    org.javamoney.bp.api.CurrencyContext currencyContext;
     ...
     */
    public static CurrencyUnitBuilder of(String currencyCode, org.javamoney.bp.api.CurrencyContext currencyContext) {
     ...
     * @param currencyCode the (unique) and identifying currency code, not null.
     */
    private CurrencyUnitBuilder(String currencyCode, org.javamoney.bp.api.CurrencyContext currencyContext) {
     ...
     * @return the Builder, for chaining.
     * @see org.javamoney.bp.api.CurrencyUnit#getDefaultFractionDigits()
     */
     ...
     * @throws org.javamoney.bp.api.MonetaryException if creation fails
     */
     ...
     * @return the new CurrencyUnit instance.
     * @see org.javamoney.bp.api.MonetaryCurrencies#getCurrency(String, String...)
     */
     ...
     * @return the new CurrencyUnit instance.
     * @see org.javamoney.bp.api.MonetaryCurrencies#getCurrency(String, String...)
     * @see org.javamoney.bp.api.MonetaryCurrencies#getCurrency(java.util.Locale, String...)
     */
